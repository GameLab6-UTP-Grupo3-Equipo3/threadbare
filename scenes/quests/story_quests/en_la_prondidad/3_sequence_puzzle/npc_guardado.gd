...
# ¡LA MAGIA AQUÍ! Esta variable "static" sobrevive aunque se reinicie el mapa
static var forzar_carga_al_iniciar: bool = false

func _ready() -> void:
	body_entered.connect(_on_body_entered)
	
	# Si el mapa acaba de reiniciarse por culpa de la tecla L, ejecutamos la restauración
